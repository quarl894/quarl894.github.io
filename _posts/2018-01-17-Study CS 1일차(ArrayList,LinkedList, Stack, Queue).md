...
## 1. 스택, 큐에 대해 설명하시오(특징, 대표적인 예, 차이점)
...
## 9. 배열과 연결리스트를 사용하는 경우 메모리 효율, 데이터 저장 위치 관련해서 설명하시오.
